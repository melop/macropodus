...
raxml_cmd="/data/software/standard-RAxML-8.2.12/raxmlHPC-PTHREADS-AVX2 -T 1 -f a -p 767 -x 23333 -#100 -m PROTGAMMAJTTX"
fasttree_cmd="fasttree -nt"
Al2Phylo_cmd="python2 /data/software/UPhO/Al2Phylo.py -m 20 -p 0.30 -t 2"
