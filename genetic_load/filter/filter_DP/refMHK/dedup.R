setwd("/data2/projects/zwang/macropodus_compare/genetic_load/all_MHK_MOP/filter_DP/refMHK")
...
# 筛选重复的区间
duplicates <- ori_dat[duplicated(ori_dat) | duplicated(ori_dat, fromLast = TRUE), ] #12530 sites
