...
write.table(dat1, file = "allpops.refMHK.SV.filtered.bed", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
write.table(dat2, file = "allpops.refMOP.SV.filtered.bed", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
write.table(dat3, file = "allpops.refMHK.SV.discarded.bed", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
write.table(dat4, file = "allpops.refMOP.SV.discarded.bed", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
