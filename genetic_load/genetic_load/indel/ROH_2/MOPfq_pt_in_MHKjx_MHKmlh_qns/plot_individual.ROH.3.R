#------------------------------------------------------------------------------------
# 设置工作目录
setwd("/data2/projects/zwang/m.hk/Snpeff/all_MHK_MOP/rho_V2.0/filtered_SOL_3.5/Individual/indel/ROH_2/MOPfq_pt_in_MHKjx_MHKmlh_qns")
...
if (nrow(result_df) == 0) {
  ...
  ggsave("allpops.refMHK.SV.Individuals_Genetic_Load_Ratio_of_ROH-HET.MOPfqpt_on_MHKjxMHKmlhqns.2.pdf", plot = p, width = 8, height = 6)
#  print(p)
}
