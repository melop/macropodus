# 设置工作目录
setwd("/data2/projects/zwang/m.hk/Snpeff/all_MHK_MOP/rho_V2.0/filtered_SOL_3.5/Individual/indel/Ration_of_HomHet")
...
dat <- read.table("genotype_proportions.txt", header=TRUE) 
# 添加种群信息
...
# 保存图形为PDF
pdf_file <- "allpops.refMHK.SV.Individuals_Genetic_Load.ProportionHom.Boxplot.pdf"
