setwd("/data2/projects/zwang/m.hk/Snpeff/all_MHK_MOP/rho_V2.0/filtered_SOL_3.5/Individual/snp/ROH_2/HIGH")

#--------------------------------------------------------------------------------------
# 文件列表，假设所有需要处理的文件都在一个列表中
file_list <- list.files(path = "/data2/projects/zwang/m.hk/Snpeff/all_MHK_MOP/rho_V2.0/filtered_SOL_3.5/Individual/snp/ROH_2/HIGH", pattern = "allpops\\.refMHK\\.NONSYN\\.filtered\\.(.*)\\.(ROH|HET)\\.bed$", full.names = TRUE)
...
for (individual in individuals) {
  ...
  # 完整路径
  roh_path <- file.path("/data2/projects/zwang/m.hk/Snpeff/all_MHK_MOP/rho_V2.0/filtered_SOL_3.5/Individual/snp/ROH_2/HIGH", roh_file)
  het_path <- file.path("/data2/projects/zwang/m.hk/Snpeff/all_MHK_MOP/rho_V2.0/filtered_SOL_3.5/Individual/snp/ROH_2/HIGH", het_file)
  ...
  # 完整路径
  interval_roh_path <- file.path("/data2/projects/zwang/m.hk/Snpeff/all_MHK_MOP/rho_V2.0/filtered_SOL_3.5/Individual/snp/ROH_2/HIGH", interval_roh_file)
  interval_het_path <- file.path("/data2/projects/zwang/m.hk/Snpeff/all_MHK_MOP/rho_V2.0/filtered_SOL_3.5/Individual/snp/ROH_2/HIGH", interval_het_file)
