#-------------------------------------------------------------------------------多个测序深度绘图
setwd("/data2/projects/zwang/m.hk/ROH/sw_rohan_DSY1/with_RZooROH")
...
# 读取新的 ROH 文件
new_ROH <- read.table("/data2/projects/zwang/m.hk/ROH/RZooRoH/MHKmlh_qns_MOPdsy/DSY-1/only_SNP/hbdseg.txt", header = T)  # 请替换为实际的文件名
...
# 打开 PDF 文件
pdf("test.DSY-1.diffDepth.sw_rohan.het_ROH.1e-3.9.V2.withRZooRoH.pdf", width = 12, height = 8)
