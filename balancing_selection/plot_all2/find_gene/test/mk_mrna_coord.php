...
//$sSp = "MHK";
$sSp = "MOP";
$sOrthologs = "/data/projects/rcui/macropodus_compare/phylodates/orthologs.txt";
//$sGFF = "/data/projects/rcui/mhk/annotations/funannotate/train/mhk.longest_isoform.genesymbol.gff3";
$sGFF = "/data/projects/rcui/mop/annotations/funannotate/train/mop.longest_isoform.genesymbol.gff3";
//$sOut = "mRNA.coord.txt";
$sOut = "mRNA.coord.MOP.txt";
